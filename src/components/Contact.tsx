      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-black mb-4">Nuestra Ubicación</h3>
            <p className="text-lg text-gray-600">Visitanos en nuestras modernas instalaciones en el corazón de Palermo</p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="aspect-w-16 aspect-h-9 lg:aspect-h-6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3284.0168903489523!2d-58.38375892425309!3d-34.603408557295034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccac630db4c11%3A0x6f56b4df1e8acf0b!2sAv.%20Corrientes%20123%2C%20C1043AAB%20CABA%2C%20Argentina!5e0!3m2!1sen!2sus!4v1703847291234!5m2!1sen!2sus"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Ubicación de Kokoro - Av. Corrientes 123, Palermo, Buenos Aires"
              ></iframe>
            </div>
            ...
            <div className="p-6 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="text-center sm:text-left">
                  <h4 className="font-semibold text-black text-lg mb-1">Kokoro Fitness Center</h4>
                  <p className="text-gray-600">Av. Corrientes 123, Palermo, Buenos Aires</p>
                  <p className="text-sm text-gray-500 mt-1">Fácil acceso en transporte público</p>
                </div>

                <div className="flex gap-3">
                  <a
                    href="https://www.google.com/maps/dir//Av.+Corrientes+123,+C1043AAB+CABA,+Argentina"
                    target="_blank"
                  ...
                  <a
                    href="https://www.google.com/maps/place/Av.+Corrientes+123,+C1043AAB+CABA,+Argentina"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Línea B - Estación Carlos Pellegrini<br />A 3 cuadras del gimnasio</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Líneas 24, 29, 39, 152<br />Parada a 1 cuadra</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600">Parking propio disponible<br />Primeras 2 horas gratis</p>
            </div>
          </div>
        </div>
      </div>
